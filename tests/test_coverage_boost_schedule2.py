...
class TestScheduleEntryAndCapture:
    ...
    def test_create_entry_and_bulk_create(
        self, planer_client: TestClient, emp_and_shift
    ):
    ...
    def test_bulk_create_and_overwrite(self, planer_client: TestClient, emp_and_shift):
        ...
        planer_client.post(
            ...
            json={
                "entries": [
                    {"employee_id": emp_id, "date": "2025-01-07", "shift_id": shift_id}
                ],
                "overwrite": True,
            },
        )
    ...
    def test_bulk_create_no_overwrite(self, planer_client: TestClient, emp_and_shift):
        ...
        res = planer_client.post(
            ...
            json={
                "entries": [
                    {"employee_id": emp_id, "date": "2025-01-08", "shift_id": shift_id}
                ],
                "overwrite": False,
            },
        )
    ...
    def test_bulk_delete_existing_entry(self, planer_client: TestClient, emp_and_shift):
        ...
        planer_client.post(
            ...
            json={
                "entries": [
                    {"employee_id": emp_id, "date": "2025-01-09", "shift_id": shift_id}
                ],
            },
        )
        # Delete via bulk
        res = planer_client.post(
            ...
            json={
                "entries": [
                    {"employee_id": emp_id, "date": "2025-01-09", "shift_id": None}
                ],
            },
        )
        assert res.status_code == 200
    ...
    def test_create_entry_and_template_capture(
        self, planer_client: TestClient, emp_and_shift
    ):
        ...
        for day in ["2025-01-06", "2025-01-07", "2025-01-08"]:
            planer_client.post(
                ...
                json={
                    "entries": [
                        {"employee_id": emp_id, "date": day, "shift_id": shift_id}
                    ],
                },
            )
    ...
    def test_apply_template_to_date(self, planer_client: TestClient):
        ...
        # Apply it
        res = planer_client.post(
            f"/api/schedule/templates/{tmpl_id}/apply",
            json={
...
class TestRestrictionCRUD:
    ...
    def test_add_restriction_success(
    ...
    def test_add_restriction_invalid_weekday(
        self, admin_client: TestClient, admin_emp_and_shift
    ):
    ...
    def test_copy_week_with_entries(self, planer_client: TestClient):
        ...
        for day in ["2025-03-10", "2025-03-11", "2025-03-12"]:
            planer_client.post(
                ...
                json={
                    "entries": [
                        {"employee_id": emp1, "date": day, "shift_id": shift_id}
                    ],
                },
            )
...
class TestCycleUpdate:
    ...
    def test_update_cycle_with_entries(self, planer_client: TestClient):
        ...
        # Create cycle
        create_res = planer_client.post(
            "/api/shift-cycles", json={"name": "WithEntries", "size_weeks": 2}
        )
        assert create_res.status_code == 200
    ...
    def test_get_cycle_with_entries(self, planer_client: TestClient):
        ...
        create_res = planer_client.post(
            "/api/shift-cycles", json={"name": "GetEntries", "size_weeks": 1}
        )
        assert create_res.status_code == 200
        cycle_id = create_res.json()["cycle"]["ID"]
