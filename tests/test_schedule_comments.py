...
class TestScheduleCommentsRead:
    ...
    def test_list_comments_by_group(self, write_client):
        ...
        write_client.post("/api/v1/schedule/comments", json={
            "date": "2025-01-15",
            "group_id": 42,
            "text": "Group 42 note",
        })
    ...
    def test_list_comments_by_date_range(self, write_client):
        ...
        resp = write_client.get(
            "/api/v1/schedule/comments?from=2025-03-01&to=2025-03-31"
        )
        assert resp.status_code == 200
        data = resp.json()
        for c in data:
...
class TestScheduleCommentsCreate:
    ...
    def test_create_comment(self, write_client):
        ...
        resp = write_client.post("/api/v1/schedule/comments", json={
            "date": "2025-06-15",
            "group_id": 1,
    ...
    def test_leser_cannot_create(self, leser_client):
        ...
        resp = leser_client.post("/api/v1/schedule/comments", json={
            "date": "2025-08-01",
            "group_id": 0,
            "text": "Should fail",
        })
...
class TestScheduleCommentsDelete:
    ...
    def test_delete_comment(self, write_client):
        ...
        # Create
        create_resp = write_client.post("/api/v1/schedule/comments", json={
            "date": "2025-12-24",
            "group_id": 0,
            "text": "Christmas note",
        })
        ...
        # Verify gone
        list_resp = write_client.get(
            "/api/v1/schedule/comments?from=2025-12-24&to=2025-12-24"
        )
        data = list_resp.json()
